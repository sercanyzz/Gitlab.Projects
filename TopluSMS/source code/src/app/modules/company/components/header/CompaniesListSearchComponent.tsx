...
const searchOptions = [
  ...
  {value: 'vknNo', label: 'Vergi Kimlik Numarası'},
  {value: 'businessPartner', label: 'İş Ortağı Adı'},
]

export const CompaniesListSearchComponent = () => {
  ...
  return (
    <div className='card-title d-flex flex-wrap'>
      ...
      <div className='d-flex align-items-center position-relative my-1'>
        ...
        <input
          type='text'
          data-kt-sms-header-table-filter='search'
